<template>
  <el-dialog
    ...
    <el-form-item label="店铺状态 ，0关门，1营业" prop="status">
      <el-input v-model="dataForm.status" placeholder="店铺状态 ，0关门，1营业"></el-input>
    </el-form-item>
    </el-form>
          ...
          if (this.dataForm.id) {
            this.$http({
              ...
              if (data && data.code === 0) {
                ...
                this.dataForm.status = data.shopInfo.status
              }
            })
          }
        })
